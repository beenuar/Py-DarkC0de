...
chunksize = int(1.4 * megabytes)                   # default: roughly a floppy and can also be changes as per the user requirement
...
def split(fromfile, todir, chunksize=chunksize): 
    ...
    partnum = 0
    input = open(fromfile, 'rb')                   # use binary mode on Windows because the split can also be of the multimedia files not only just text.
